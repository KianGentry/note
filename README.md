...
- [x] [else] - Treat anything else as a name for new note, except...
...
- [x] Config file at ~/.config/noterc
- [ ] A configurable "timeout" period for notes (e.g. deleted after 1h).
- [x] Configurable text editor to use.
